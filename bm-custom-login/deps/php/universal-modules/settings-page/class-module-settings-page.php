...
namespace Teydea_Studio\Custom_Login\Dependencies\Universal_Modules\Settings_Page;
...
class Module_Settings_Page extends Utils\Module {
	...
	protected function get_page_slug(): string {
		return Utils\Settings_Page_URLs::page_slug( $this->container );
	}
	...
	public function is_settings_page(): bool {
		return Utils\Settings_Page_URLs::is_current_screen( $this->container );
	}
