 ...
 *
 * @return {Element} ProductIcon component.
 */
export const ProductIcon = ( { slug } ) => {
	...
	switch ( slug ) {
		...
		case 'password-requirements':
			return (
				<div className="tsc-product-icon">
					<SVG fill="none" height="256" viewBox="0 0 512 512" width="256" xmlns="http://www.w3.org/2000/svg">
						<Path
							fill="#e1efff"
							d="M372.364 0H139.636C62.517 0 0 62.517 0 139.636v232.728C0 449.483 62.517 512 139.636 512h232.728C449.483 512 512 449.483 512 372.364V139.636C512 62.517 449.483 0 372.364 0"
						/>
						<Path
							fill="#c7e0fc"
							d="M256.36 231.331h169.406l-1.081 13.084a193.05 193.05 0 0 1-80.061 141.497l-88.264 63.046zm-.053 0H86.901l1.081 13.084a193 193 0 0 0 24.409 79.587 193 193 0 0 0 55.652 61.91l88.264 63.046z"
						/>
						<Path fill="#c7e0fc" d="M256.356 231.357V62.082l169.275 72.542v96.733zm-169.274 0v-96.706l169.274-72.569v169.275z" />
						<Path stroke="#c7e0fc" d="M256.5 418v17" />
						<Path stroke="#92bcea" d="M256.5 418V278" />
						<Path
							fill="#92bcea"
							d="M256.522 235H399l-.91 11.062a163.8 163.8 0 0 1-20.528 67.29 162.9 162.9 0 0 1-46.806 52.344L256.522 419zm-.044 0H114l.91 11.062a163.8 163.8 0 0 0 20.528 67.29 162.9 162.9 0 0 0 46.806 52.344L256.478 419zM256.5 235V92L399 153.283V235zM114 235v-81.695L256.5 92v143z"
						/>
						<Path
							fill="#05157f"
							d="m249.339 458.799-88.264-63.046A205.88 205.88 0 0 1 75 228.509V134.6a12.14 12.14 0 0 1 7.333-11.106l169.275-72.542a12.32 12.32 0 0 1 9.496 0l169.275 72.542a12.12 12.12 0 0 1 7.333 11.106v93.909a205.94 205.94 0 0 1-86.048 167.244l-88.291 63.046a12.14 12.14 0 0 1-14.034 0m-150.15-316.18v85.89a181.59 181.59 0 0 0 75.92 147.565l81.247 58.034 81.248-58.034a181.648 181.648 0 0 0 75.919-147.591v-85.864L256.356 75.221z"
						/>
						<Path
							fill="#05157f"
							d="M256.155 276.62a10.42 10.42 0 0 1-10.423-10.423v-62.584a10.44 10.44 0 0 1 3.053-7.37 10.43 10.43 0 0 1 11.359-2.259 10.43 10.43 0 0 1 5.641 5.641c.523 1.264.793 2.62.793 3.988v62.584a10.423 10.423 0 0 1-10.423 10.423"
						/>
						<Path
							fill="#05157f"
							d="m276.865 259.507-52.161-31.292a10.435 10.435 0 0 1-3.573-14.315 10.434 10.434 0 0 1 14.314-3.573l52.161 31.292a10.42 10.42 0 0 1 4.751 6.417 10.433 10.433 0 0 1-15.492 11.471"
						/>
						<Path
							fill="#05157f"
							d="M221.131 255.933a10.43 10.43 0 0 1-1.182-7.898 10.42 10.42 0 0 1 4.755-6.416l52.161-31.292a10.42 10.42 0 0 1 7.897-1.179 10.44 10.44 0 0 1 7.792 8.583 10.43 10.43 0 0 1-4.947 10.483l-52.161 31.292a10.42 10.42 0 0 1-11.58-.556 10.4 10.4 0 0 1-2.735-3.017m118.477 20.687a10.42 10.42 0 0 1-9.65-6.429 10.4 10.4 0 0 1-.796-3.994v-62.584a10.435 10.435 0 0 1 20.869 0v62.584a10.423 10.423 0 0 1-10.423 10.423"
						/>
						<Path
							fill="#05157f"
							d="m360.317 259.506-52.161-31.292a10.432 10.432 0 1 1 10.742-17.887l52.138 31.292a10.42 10.42 0 0 1 4.955 10.472 10.43 10.43 0 0 1-11.843 8.785 10.4 10.4 0 0 1-3.831-1.37"
						/>
						<Path
							fill="#05157f"
							d="M304.584 255.933a10.418 10.418 0 0 1 3.573-14.314l52.161-31.292a10.4 10.4 0 0 1 3.831-1.375 10.442 10.442 0 0 1 11.858 8.779 10.442 10.442 0 0 1-4.948 10.483l-52.16 31.292a10.43 10.43 0 0 1-7.912 1.193 10.42 10.42 0 0 1-6.426-4.766zM172.703 276.62a10.42 10.42 0 0 1-9.63-6.434 10.4 10.4 0 0 1-.793-3.989v-62.584a10.434 10.434 0 1 1 20.869 0v62.584a10.426 10.426 0 0 1-10.446 10.423"
						/>
						<Path
							fill="#05157f"
							d="m193.412 259.506-52.138-31.292a10.42 10.42 0 0 1-4.754-6.409 10.42 10.42 0 0 1 1.17-7.894 10.424 10.424 0 0 1 14.303-3.584l52.161 31.292a10.44 10.44 0 0 1 4.947 10.483 10.43 10.43 0 0 1-11.857 8.779 10.5 10.5 0 0 1-3.832-1.375"
						/>
						<Path
							fill="#05157f"
							d="M137.701 255.933a10.42 10.42 0 0 1 3.573-14.314l52.138-31.292a10.4 10.4 0 0 1 3.831-1.375 10.442 10.442 0 0 1 11.858 8.779 10.43 10.43 0 0 1-4.948 10.483l-52.16 31.292a10.424 10.424 0 0 1-14.292-3.573"
						/>
					</SVG>
				</div>
			);
